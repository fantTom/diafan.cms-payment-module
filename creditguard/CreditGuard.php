...
class CreditGuard
{
    ...
    private $mpiValidation = "AutoComm"; //Normal, Token, Verify, AutoComm, AutoCommHold, CardNo
     ...
     * @return array
     */
    public function getRedirectUrl($uniqueId = "", $total = 1.0, $payments = 0, $userData1, $userData2, $userData3, $userData4, $userData5, $userData6, $userData7, $userData8, $userData9, $userData10)
    {
        if (empty($uniqueId)) {
            $uniqueId = uniqid();
        }
